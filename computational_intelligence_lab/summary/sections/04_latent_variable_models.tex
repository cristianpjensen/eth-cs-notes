...
content is invariant to word order. \sidenote{Mathematically, this is known as
    \textit{exchangeability}, which says that the distribution of a sequence of random variables does
    not change under any permutation of their order.} As a consequence, the sufficient statistics of a

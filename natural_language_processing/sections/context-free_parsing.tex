\section{Context-free parsing} \label{sec:cfg}
...
\begin{definition}[Context-free grammar]
  ...
  \begin{enumerate}
    ...
    \item \cat{S}: A distinguished start non-terminal. Every complete parse tree
...
\Cref{fig:cky-chart} for an illustration of how the algorithm works. It starts

...
2D image presenting the projection of the 3D motion of points in the scene onto
the image plane.} In other words, optical flow does not represent the actual

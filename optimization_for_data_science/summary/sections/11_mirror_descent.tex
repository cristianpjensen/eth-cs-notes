...
replaced by a Bregman divergence,\sidenote{Using \Cref{item:euc} of \Cref{ex:bregman} recovers the
    subgradient method, and \Cref{item:kl} recovers Entropic descent, \[
        \vec{x}_{t+1} \propto \vec{x}_t \odot \exp(-\gamma_t \vec{g}_t).
    \]} \[

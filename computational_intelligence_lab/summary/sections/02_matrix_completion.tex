...
Since the matrix in the first term is rank-$k$,\sidenote{This is because of the identity matrix,
    which is a result of the regularization.} we can invert it, and thus we have the following
...
We will now consider optimizing the objective by gradient descent. However, gradient descent does

...
\begin{definition}[Fundamental matrix]
  ...
  2,\sidenote{$\mat{F}$ has 7 degrees of freedom, because it is a $3\times 3$
...
\begin{definition}[Essential matrix]
  ...
  matrix (\cref{def:fundamental-matrix}),\sidenote{$\mat{E}$ has 5 degrees of
  freedom, because it has the same parameters as the fundamental matrix, minus
